...
describe('Model Management', () => {
  ...
  describe('Translation Flow Logic', () => {
    ...
    it('should handle download progress updates correctly', () => {
      ...
      expect(() => updateDownloadProgress(50, 25)).toThrow('Progress cannot decrease')
      expect(() => updateDownloadProgress(50, -10)).toThrow('Progress must be between 0 and 100')
      expect(() => updateDownloadProgress(50, 150)).toThrow('Progress must be between 0 and 100')
    })
  })
