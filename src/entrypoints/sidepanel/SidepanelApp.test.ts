...
> = {
  processText: vi.fn(() => Promise.resolve(PROCCESED_TEXT)),
...
const PROCCESED_TEXT = 'Texto procesado';
...
describe('SidepanelApp', () => {
  ...
  it('should not show api warning when available on initialization', async () => {
  ...
  it('should show "localProcessingBadge" indicator when using native API', async () => {
    ...
    (mockAIService.detectLanguage).mockResolvedValue(detectedLanguage);
    (mockAIService.processText).mockResolvedValue(PROCCESED_TEXT);
